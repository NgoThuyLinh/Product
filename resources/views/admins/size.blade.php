...
@section('content')
	<div class="content-header">
		...
		<button type="button" class="btn btn-primary" style="margin-top:15px;" data-toggle="modal" data-target="#add"><i class=" fa fa-plus" style="margin-right:10px"></i>Create size</button>
		<ol class="breadcrumb">
		    <li><a href=""><i class="fa fa-dashboard"></i> Home/ </a></li>
		    <li class="active"><a href="{{asset('vendor')}}">size/</a></li>
			...
			<!-- Modal content-->
				<div class="modal-content">
				  	<div class="modal-header">
				    	...
				    	<h4 class="modal-title">Information size</h4>
				  	</div>
    ...
    <script type="text/javascript" src="{{mix('js/admin/size.js')}}"></script>
